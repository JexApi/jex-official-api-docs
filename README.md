...
[GET /api/v1/contract/userHistoricalTrades (HMAC SHA256)](./rest-api.md#contract-bill-of-the-accountuser_data-1) | contract historical transaction information(Descending by ID)
[GET /api/v1/contract/userHistoricalTradesLately (HMAC SHA256)](./rest-api.md#contract-bill-of-the-accountuser_data-1) | contract historical transaction information(Descending by time)
[DELETE /api/v1/contract/batchOrder (HMAC SHA256)](./rest-api.md#cancel-all-orders) | cancel all orders
[GET /api/v1/contract/batchOrder (HMAC SHA256)](./rest-api.md#query-contract-all-orders) | query contract all orders
